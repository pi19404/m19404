...
import com.android.gesture.DataCapture;
 ...
 * </p>
 */
public class AndroidDollar extends GraphicsActivity {
    /** Used as a pulse to gradually fade the contents of the window. */
	public static String appname="AndroidDollar";
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		String appdir=path+"/"+AndroidDollar.appname;
		Settings set=new Settings(appdir,appdir);
		try
		{
		panel=new DataCapture(set);
		}
		catch(Exception e)
		{
			e.printStackTrace();
