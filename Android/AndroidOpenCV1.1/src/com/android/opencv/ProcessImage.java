...
import com.android.main.AndOCVFaceDetectionEx;
...
@Platform(value="android", includepath=androidIncludepath, linkpath=androidLinkpath,include="AndroidOpenCVProcessImage.hpp",
...
public class ProcessImage {
    ...
    public static class OpenCVProcess extends Pointer {
        ...
        public OpenCVProcess() { 
        	allocate();
        	Log.e("EEEE",""+AndOCVFaceDetectionEx.APPLICATION_DIR+"/haarcascade_frontalface_alt.xml");
        	initDetector(AndOCVFaceDetectionEx.APPLICATION_DIR+"/haarcascade_frontalface_alt.xml");
        }
        private native void allocate();
        public native @ByRef int run(int width, int height, byte yuv[], int[] rgba);
