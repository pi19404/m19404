...
public class BandTest
{
      ...
      public static void main(String[] args)
      {
         ...
         else
         {
            ...
            final TimeWarpInfo info = com.android.fastdtw.dtw.dtw.DTW.getWarpInfoBetween(tsI, tsJ, new LinearWindow(tsI, tsJ, Integer.parseInt(args[2])), distFn);
