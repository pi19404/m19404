...
package com.android.fastdtw.dtw.timeseries;
...
import com.android.fastdtw.dtw.Point;
import com.android.fastdtw.dtw.util.Arrays;
...
public class TimeSeries
{
   ...
   // PRIVATE DATA
   private  ArrayList labels;   // labels for each column
   private  ArrayList timeReadings;        // ArrayList of Double
   private  ArrayList tsArray;    // ArrayList of TimeSeriesPoint.. no time
      ...
      try
      {
         ...
         for(x=0;x<count;x++)   // read lines until end of file
         {
               ...
               final TimeSeriesPoint readings = 
            		   new TimeSeriesPoint(currentLineValues.subList(firstMeasurement,
                       currentLineValues.size()));
               tsArray.add(readings);
//
            }  // end if
