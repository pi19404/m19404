		...
		while(true)
		{
			...
			if(cmd.startsWith("svm_type"))
			{
				...
				if(i == svm_type_table.length)
				{
					...
					return null;
                                ...
                                //Log.e("SVM","svm type is "+param.svm_type);
			}
			else if(cmd.startsWith("kernel_type"))
			{
				...
				if(i == kernel_type_table.length)
				{
					...
					return null;
                                 ...
                                 //Log.e("SVM","kernel type is "+param.kernel_type);
			}
			...
			else if(cmd.startsWith("label"))
			{
				...
				for(int i=0;i<n;i++)
					...
					model.label[i] = atoi(st.nextToken());					
                                       // Log.e("SVM","labels is "+model.label[i]);
                                }
			}
			...
			else if(cmd.startsWith("nr_sv"))
			{
				...
				for(int i=0;i<n;i++)
					...
					model.nSV[i] = atoi(st.nextToken());
                                        //Log.e("SVM","number of support vectors  is "+model.nSV[i]);
                                }
			}
			...
			else
			{
				...
				return null;
                 ...
                 //Log.e("SVM","number of classes  is "+model.nr_class);
